...
while (True) :
		...
		Gx_angle = float(getDT()) * Ax * (180 / 3.14158) * 100
		Gy_angle = float(getDT()) * Ay * (180 / 3.14158) * 100
		Gz_angle = float(getDT()) * Az * (180 / 3.14158) * 100
		print ("dt = %.5f" %getDT(), "Gy_x=%.5f" %Gx_angle, u'\u00b0', "Gy_y=%.5f" %Gy_angle, u'\u00b0', "Gy_z=%.5f" %Gz_angle, u'\u00b0')
		time.sleep(0.1)
